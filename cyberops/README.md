...
> **Running in production at [cyberops.mdlc.ai](https://cyberops.mdlc.ai).** One of twelve reference apps built end-to-end with the **[MDLC](https://mdlc.ai)** methodology, from a `RESEARCH.md` blueprint, through architecture and build, to a passing set of quality gates. Nothing here was hand-tuned after generation.
